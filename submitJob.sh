...
numberSecondsPerTemp=10000
numberOfRounds=40
T_top=5.0
T_bot=0.0005
temp_scan=1 #divides T_top to T_bot in numberOfRounds/2 intervals and all parallel processes cyclic around all temp bins. 
...
cp ${dir_origin}/evaluate_experiment_temperatures.ipynb .
...
$overlapRatio $eta $alpha $T_top $T_bot $numberSecondsPerTemp $numberOfRounds $structure $inputFile $temp_scan
